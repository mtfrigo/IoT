...
class LED(object):
    ...
    def __init__(self, pin=12, count=1):
    ...
    def setGreen(self):
        self.colorWipe(self.strip, Color(0,255,0), 10)

    def setRed(self):
        self.colorWipe(self.strip, Color(255,0,0), 10)

    def setBlue(self):
        self.colorWipe(self.strip, Color(0,0,255), 10)
